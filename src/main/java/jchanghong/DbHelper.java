...
import jchanghong.db.sqlite.*;
import jchanghong.db.table.KeyValue;
import jchanghong.db.table.ManyToOne;
import jchanghong.db.table.OneToMany;
import jchanghong.db.table.TableInfo;
import jchanghong.exception.DbException;
...
public class DbHelper {
    ...
    private static HashMap<String, DbHelper> daoMap = new HashMap<String, DbHelper>();
     ...
     */
    public static DbHelper create(Context context, boolean isDebug) {
        DaoConfig config = new DaoConfig();
        config.setContext(context);
     ...
     */
    public static DbHelper create(Context context, String dbName, boolean isDebug) {
        DaoConfig config = new DaoConfig();
        config.setContext(context);
        config.setDbName(dbName);
        config.setDebug(isDebug);
     ...
     * @param dbName  数据库名称
     */
    public static DbHelper create(Context context, String targetDirectory,
                                  String dbName) {
        DaoConfig config = new DaoConfig();
        config.setContext(context);
        config.setDbName(dbName);
